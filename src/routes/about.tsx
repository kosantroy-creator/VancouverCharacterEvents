...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A local Metro Vancouver team crafting premium, magical character experiences." },
...
function AboutPage() {
  return (
    <>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-5 space-y-4 text-lg leading-relaxed text-fg-2">
              <p>
                We're a team of professional performers and event specialists who treat every booking as a story worth
                telling well. From an intimate backyard birthday to a busy mall activation, we bring the same standard of
                presentation, preparation, and care.
              </p>
              <p>
                Each of our service categories is a chapter in one magical Vancouver storybook — princesses, heroes,
                dinosaurs, mermaids, mascots, holiday characters, and corporate experiences — all delivered by one
                trusted local team.
              </p>
              <p>
                The result is entertainment that feels effortless for you and unforgettable for your guests: structured,
                audience-aware, beautifully costumed, and reliably on time.
              </p>
            </div>
          </div>
      ...
      <Section tone="cream">
        <SectionHeading eyebrow="What sets us apart" title="Premium experiences, organized execution" />
      ...
      <Section tone="page" className="text-center">
        ...
        <h2 className="font-display text-3xl text-fg md:text-4xl">Let's create something magical</h2>
        <p className="mx-auto mt-3 max-w-xl text-lg text-fg-2">
          Whether it's a birthday, a classroom, or a city festival, we'd love to help bring your story to life.
        </p>
        <div className="mt-7">
